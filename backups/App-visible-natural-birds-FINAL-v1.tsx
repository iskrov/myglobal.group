    ...
    class Bird {
      ...
      draw(): void {
        ...
        this.trail.forEach((point, i) => {
          ...
          ctx!.fillStyle = 'rgba(47, 127, 255, 0.3)';
          ctx!.beginPath();
        ...
        // VISIBLE COLORS - bright blue/white against dark background
        ctx!.strokeStyle = 'rgba(100, 170, 255, 0.9)'; // Light blue for wings
        ctx!.fillStyle = 'rgba(120, 180, 255, 0.95)'; // Slightly brighter for body
        ctx!.lineWidth = this.size * 0.4;
        ctx!.lineCap = 'round';
        ctx!.lineJoin = 'round';
        
        // Add subtle glow for visibility
        ctx!.shadowColor = 'rgba(47, 127, 255, 0.5)';
        ...
        // Small body/head - brighter center
