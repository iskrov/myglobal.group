  ...
  useEffect(() => {
    ...
    class Bird {
      ...
      draw(): void {
        ...
        const wingExtension = 2.5 + wingFlap * 0.5;
        
        ctx!.strokeStyle = 'rgba(47, 127, 255, 0.8)';
        ...
        ctx!.quadraticCurveTo(
          -this.size * wingExtension * 0.8, 
          -this.size * (1.5 + wingFlap * 0.8),
          -this.size * wingExtension,
          -this.size * (1 + wingFlap * 0.5)
        );
        ctx!.stroke();
